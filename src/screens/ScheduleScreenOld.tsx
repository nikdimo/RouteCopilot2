...
import DaySlider from '../components/DaySliderOld';
import SwipeableMeetingRow from '../components/SwipeableMeetingRowOld';
import LegBetweenRow from '../components/LegBetweenRowOld';
import DaySummaryBar from '../components/DaySummaryBarOld';
...
export default function ScheduleScreenOld() {
